// Source: https://rednafi.com/javascript/cors_proxy_with_cloudflare_workers/ & https://github.com/rednafi/cors-proxy
// With modifications
export default {
	async fetch(request, env, ctx) {
		// Extract data from the incoming request object
